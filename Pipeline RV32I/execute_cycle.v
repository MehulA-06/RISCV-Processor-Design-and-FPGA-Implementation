...
module execute_cycle(
    ...
    input [31:0] ResultW, // From WB stage for forwarding
    input [31:0] ALU_ResultM, // From MEM stage for forwarding
    ...
    output [2:0] Funct3_M // Added Funct3_M
);
...
assign PCTargetE = (JumpE && ALUControlE == 4'b0000 && !ALUSrcE) ? (Src_A + Imm_Ext_E) : (PCE + Imm_Ext_E);
